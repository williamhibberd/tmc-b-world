...
export default class toLobby extends Transition {
	...
	onEnter({ to, trigger, done }) {
		document.querySelector("#apple-touch-icon").href =
			"/favicon/lobby/apple-touch-icon.png";
		document.querySelector("#icon-large").href =
			"/favicon/lobby/favicon-32x32.png";
		document.querySelector("#icon-small").href =
			"/favicon/lobby/favicon-16x16.png";
		document.querySelector("#mask").setAttribute("color", "#27369c");
		document
			.querySelector("#tile-color")
			.setAttribute("content", "#27369c");
