...
export const lobbyTexture = textureLoader.load(
	"/images/lobby/lobby-hr-20-02-23.jpg"
);
lobbyTexture.mapping = THREE.EquirectangularReflectionMapping;
lobbyTexture.encoding = THREE.sRGBEncoding;

export const libraryTexture = textureLoader.load(
	"/images/library/library-hr-20-02-23.jpg"
);
...
export const outsideTexture = textureLoader.load(
	"/images/outside/outside-hr-20-02-23.jpg"
);
